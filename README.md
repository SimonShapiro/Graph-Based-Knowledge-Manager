...
The reference implementation is based on couchdb. The database stores each knowledge graph as a separate document. A demo version is availble [here](http://52.208.94.243).
